...
p1 = gr.Gravity(1.989*10**30, 5.9742*10**24, 1898*10**24, 6.67408*10**(-11), 0, 0, 1.486*10**11, 0, 7.785*10**11, 0, 0, 0, 0, 29783, 0, 0, dt, t)
...
plt.legend(loc='best')
plt.title("x-y graf")
plt.savefig("solar_system_steady_jupiter")
plt.show()